...
def test_sh_mqttSuspend():
  irrigate, logger, valves, q, cfg = test_sh_mqttQueue()
  time.sleep(2)
  irrigate.mqtt.processMessages("xxx/suspend/Test1/command", 1)
  time.sleep(1)
  duration = valves['Test1'].secondsDaily
  time.sleep(3)
  assert duration == valves['Test1'].secondsDaily
  irrigate.mqtt.processMessages("xxx/suspend/Test1/command", 0)
  time.sleep(3)
  assert duration < valves['Test1'].secondsDaily
...
def test_sh_sensorOverridesMqtt():
  ...
  irrigate.mqtt.processMessages("xxx/suspend/Test5/command", 0)
  time.sleep(3)
...
def test_sh_mqttErrors():
  ...
  irrigate.start()
  time.sleep(2)
  irrigate.mqtt.processMessages("xxx/suspend/Test1/command", "asd")
  time.sleep(1)
  irrigate.mqtt.processMessages("xxx/queue/Test1/command", "asd")
  time.sleep(1)
  irrigate.mqtt.processMessages("xxx/enable/Test1/command", "")
  time.sleep(1)
  irrigate.mqtt.processMessages("xxx/suspend/Test1/command", 4)
  time.sleep(1)
